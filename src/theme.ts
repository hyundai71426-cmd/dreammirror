...
export const THEME_STYLES: Record<string, ThemeStyle> = {
  ...
  zen: {
    ...
    appBg: "bg-[#EFECE6] text-stone-800",
    containerBg: "bg-[#FDFBF7] text-stone-800 border-stone-200",
    textPrimary: "text-stone-950 font-semibold",
    textSecondary: "text-stone-600 font-medium",
    textMuted: "text-stone-400",
    borderBase: "border-stone-200",
    headerBg: "bg-[#FDFBF7]/95 border-b border-stone-200 backdrop-blur-md",
    bottomNavBg: "bg-[#FDFBF7]/95 border-t border-stone-200 backdrop-blur-md",
    cardBg: "bg-[#FAF7F0] border border-stone-200 hover:bg-[#F2EDE1] transition-all shadow-sm rounded-3xl",
    cardBorder: "border-stone-200",
    accentText: "text-amber-850",
    accentBtn: "bg-stone-900 hover:bg-stone-800 text-[#FDFBF7] font-extrabold shadow-sm active:scale-95",
    accentBtnText: "text-[#FDFBF7]",
    badgeBg: "bg-stone-200 border border-stone-300 text-stone-700",
    badgeText: "text-stone-700 font-bold",
    baseTextSize: "text-[15px] leading-loose tracking-wide font-sans",
    smallTextSize: "text-[12px] font-bold text-stone-600",
    titleSize: "text-2xl font-black tracking-tight text-stone-900",
    tabActive: "text-stone-950 bg-stone-150/70 font-extrabold border-b-2 border-stone-800",
